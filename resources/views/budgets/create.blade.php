                ...
                <div class="p-6">
                    <form action="{{ route('budgets.store') }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <select id="period_type" name="period_type" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
